...
#     # THIS SIGNAL IS DEPRECATED AND DISABLED.
#     # The functionality is now handled by the `seed_nested_territories` management command.
#     # It was causing extreme performance degradation during `loaddata`.
#
#     # When loading data from a fixture, the `raw` keyword argument will be True.
#     # We want to skip the signal logic during fixture loading to avoid conflicts and for performance.
